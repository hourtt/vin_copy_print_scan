<x-dropdown align="right" width="60">
    <x-slot name="trigger">
        <button class="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition-colors duration-200">
    ...
    <x-slot name="content">
        ...
        <x-dropdown-link href="#" divider="true" destructive="true">
            <x-slot name="icon">
