        ...
        <div class="max-w-[1280px] mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        @foreach ($featured->take(4) as $product)
                            <div
                                class="bg-white border border-[#1a1a2e]/10 rounded-xl overflow-hidden flex flex-col hover:shadow-lg transition-shadow duration-300">
                                <div class="relative bg-[#f8f9fa] p-6 flex justify-center h-[200px]">
                                    <span
                                        class="absolute top-4 left-4 bg-blue-100 text-blue-900 text-xs font-semibold px-2 py-1 rounded">New
                                        Arrival</span>
                                    @if ($product->image)
                                ...
                                <div class="p-6 flex-1 flex flex-col">
                                    <h3 class="font-sans text-lg font-semibold text-[#1a1a2e] mb-2">{{ $product->name }}
                                    </h3>
                                    <p class="text-sm text-[#1a1a2e]/60 mb-6 leading-relaxed flex-1">
                                        {{ Str::limit($product->description, 60) }}</p>
                                    <div class="flex justify-between items-center">
                                        <span
                                            class="text-xl font-bold text-[#1a1a2e]">${{ number_format($product->price, 2) }}</span>
                                        <button class="order-btn">Take a look</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="flex flex-col gap-6 lg:col-span-1">
                    {{-- Essential Toners --}}
                    <div
                        class="bg-white border border-[#1a1a2e]/10 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center justify-between pb-4 border-b border-[#f8f9fa]">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-12 h-12 bg-[#f8f9fa] rounded flex items-center justify-center text-[#1a1a2e]/50">
                                ...
                                <button
                                    class="bg-transparent border border-[#1a1a2e]/10 text-[#1a1a2e]/50 w-6 h-6 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-100 hover:text-[#1a1a2e] transition-colors">+</button>
                            </div>
                            <div class="flex items-center justify-between pb-4 border-b border-[#f8f9fa]">
                                <div class="flex items-center gap-4">
                                    <div
                    ...
                    <div
                        class="bg-blue-100 border-none rounded-xl p-6 relative overflow-hidden flex flex-col justify-between hover:shadow-lg transition-shadow duration-300">
                        ...
                        <svg class="absolute -right-2.5 -bottom-2.5 w-[100px] h-[100px] text-blue-300 opacity-40 z-0"
