<nav x-data="{ mobileMenuOpen: false }" class="bg-white border-b border-gray-200 sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-8">
                ...
                <div x-data="{ dropdownOpen: false }" class="relative" @click.outside="dropdownOpen = false">
                    <button @click="dropdownOpen = !dropdownOpen" class="relative group flex items-center text-[#0D0D0B] hover:text-[#0818A8] px-3 py-2 rounded-md text-sm font-medium">
                        Products
                ...
                <!-- Services -->
                <a href="{{ route('services') }}" class="relative group text-[#0D0D0B] hover:text-[#0818A8] px-3 py-2 rounded-md text-sm font-medium">
                    Services
                    <span class="absolute bottom-0 left-0 w-full h-0.5 bg-[#0818A8] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
                </a>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                @auth
                    <!-- Cart -->
                    <a href="#" class="text-[#0D0D0B] hover:text-[#0818A8]">
                    ...
                    <div x-data="{ accountOpen: false }" class="hidden sm:block relative" @click.outside="accountOpen = false">
                        <button @click="accountOpen = !accountOpen" class="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0818A8]">
                            <svg class="h-8 w-8 text-[#0D0D0B] hover:text-[#0818A8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex items-center lg:hidden">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="inline-flex items-center justify-center p-2 rounded-md text-[#0D0D0B] hover:text-[#0818A8] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#0818A8]">
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('services') }}" class="block px-4 py-2 text-base font-medium text-[#0D0D0B] hover:text-[#0818A8] hover:bg-gray-50">Services</a>
        </div>
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
            @auth
                ...
                <div class="space-y-1 sm:hidden">
                    <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-[#0818A8] hover:bg-gray-50">Profile</a>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
            ...
            @else
                <!-- Mobile Guest Links -->
                <div class="space-y-1 sm:hidden">
                    <a href="{{ route('login') }}" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-[#0818A8] hover:bg-gray-50">Sign In</a>
                    <a href="{{ route('register') }}" class="block px-4 py-2 text-base font-medium text-[#0818A8] hover:bg-gray-50">Register</a>
                </div>
            @endauth
        </div>
    </div>
