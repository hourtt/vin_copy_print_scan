<x-app-layout>
    <div class="settings-layout">
        ...
        <aside class="settings-global-nav">
            ...
            <div class="global-nav-bottom">
                ...
                <div class="w-full flex justify-center">
                    <button type="button" class="global-nav-item text-[#fca5a5] hover:bg-[#ef4444]/10 hover:text-[#ef4444]" aria-label="Log Out" onclick="openLogoutModal()">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <nav class="settings-sidebar">
            ...
            <div class="settings-sidebar-nav">
                ...
                <button class="settings-tab" type="button" onclick="openModal('modal-password')">Login &amp; Security</button>
            ...
            <div class="settings-content">
                ...
                <div class="settings-header-section">
                    ...
                    <div class="settings-header-info">
                        <h2 class="settings-header-name">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h2>
                        <div class="settings-avatar-actions">
                            <button type="button" class="btn-outline-sm">Upload new</button>
                            <button type="button" class="btn-outline-sm text-[#ef4444] hover:bg-[#fef2f2] hover:border-[#fca5a5]">Delete</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="settings-row-group">
                    ...
                    <div class="settings-row">
                        ...
                        <div class="settings-row-action">
                            <button type="button" class="btn-edit-link" onclick="openModal('modal-profile-info')">Edit</button>
                        </div>
                    </div>
                ...
                <div class="settings-row-group">
                    ...
                    <div class="settings-row">
                        ...
                        <div class="settings-row-action">
                            <button type="button" class="btn-edit-link" onclick="openModal('modal-address')">Edit</button>
                        </div>
                    </div>
    ...
    ═══════════════════════════════════════════════════════════ --}}
    <div class="profile-modal-overlay group" id="modal-profile-info" role="dialog" aria-modal="true" aria-labelledby="modal-profile-info-title">
    ...
    ═══════════════════════════════════════════════════════════ --}}
    <div class="profile-modal-overlay group" id="modal-password" role="dialog" aria-modal="true" aria-labelledby="modal-password-title">
        <div class="profile-modal-panel group-[.active]:translate-y-0 group-[.active]:scale-100">
            <div class="profile-modal-header">
    ...
    ═══════════════════════════════════════════════════════════ --}}
    <div class="profile-modal-overlay group" id="modal-payment" role="dialog" aria-modal="true" aria-labelledby="modal-payment-title">
        <div class="profile-modal-panel group-[.active]:translate-y-0 group-[.active]:scale-100">
            <div class="profile-modal-header">
            ...
            <div class="text-center py-10 px-6">
                <div class="w-14 h-14 rounded-2xl bg-[rgba(212,165,116,0.15)] flex items-center justify-center mx-auto mb-5 text-[var(--gold)]">
                ...
                <button type="button" class="profile-btn-primary max-w-[180px] mx-auto block" onclick="closeModal('modal-payment')">Got it</button>
            </div>
        </div>
    </div>
    ...
    ═══════════════════════════════════════════════════════════ --}}
    <div class="profile-modal-overlay group" id="modal-address" role="dialog" aria-modal="true" aria-labelledby="modal-address-title">
        <div class="profile-modal-panel group-[.active]:translate-y-0 group-[.active]:scale-100">
            <div class="profile-modal-header">
            ...
            <div class="text-center py-10 px-6">
                <div class="w-14 h-14 rounded-2xl bg-[rgba(216,90,48,0.1)] flex items-center justify-center mx-auto mb-5 text-[var(--coral)]">
                ...
                <button type="button" class="profile-btn-primary max-w-[180px] mx-auto block" onclick="closeModal('modal-address')">Got it</button>
            </div>
        </div>
    </div>
